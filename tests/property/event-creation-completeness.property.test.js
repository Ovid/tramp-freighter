    ...
    fc.assert(
      fc.property(
        ...
        (eventType1, systemId1, day1, eventType2, systemId2, day2) => {
          const event1 = EconomicEventsSystem.createEvent(
            eventType1,
            systemId1,
            day1
          );
          const event2 = EconomicEventsSystem.createEvent(
            eventType2,
            systemId2,
            day2
          );
  ...
  it('should create events with correct modifiers for each type', () => {
    fc.assert(
      fc.property(
        ...
        (systemId, currentDay) => {
          // Test mining_strike
          const miningStrike = EconomicEventsSystem.createEvent(
            'mining_strike',
            systemId,
            currentDay
          );
          ...
          const medicalEmergency = EconomicEventsSystem.createEvent(
            'medical_emergency',
            systemId,
            currentDay
          );
          ...
          // Test festival
          const festival = EconomicEventsSystem.createEvent(
            'festival',
            systemId,
            currentDay
          );
