        ...
        fc.assert(
            fc.property(
                ...
                (knownSystems) => {
                    ...
                    const systemItems = marketDataList.querySelectorAll('.market-data-system');
                    
                    // Property: Should display one item per system with known prices
                    const uniqueSystemIds = [...new Set(knownSystems.map(s => s.systemId))];
        ...
        fc.assert(
            fc.property(
                ...
                (systemId, lastVisit) => {
                    ...
                    const priceItems = systemItem.querySelectorAll('.market-data-price-item');
        ...
        fc.assert(
            fc.property(
                ...
                (systemId, lastVisit) => {
                    ...
                    const marketDataList = document.getElementById('market-data-list');
                    const systemItem = marketDataList.querySelector('.market-data-system');
                    const stalenessElement = systemItem.querySelector('.market-data-staleness');
                    ...
                    if (lastVisit === 0) {
                        ...
                        expect(stalenessElement.textContent).toContain(`${lastVisit} days old`);
                    }
                    
                    // Property: Staleness should have correct CSS class
                    if (lastVisit > 30) {
                        expect(stalenessElement.classList.contains('very-stale')).toBe(true);
            ...
            fc.property(
                ...
                (knownSystems) => {
                    ...
                    systemItems.forEach(item => {
                        const stalenessText = item.querySelector('.market-data-staleness').textContent;
        ...
        fc.assert(
            fc.property(
                ...
                (systemId) => {
                    ...
                    const marketDataList = document.getElementById('market-data-list');
                    const systemItem = marketDataList.querySelector('.market-data-system');
                    const systemNameElement = systemItem.querySelector('.market-data-system-name');
        ...
        fc.assert(
            fc.property(
                ...
                (systemId, initialLastVisit) => {
                    ...
                    const marketDataList = document.getElementById('market-data-list');
                    let systemItems = marketDataList.querySelectorAll('.market-data-system');
                    const initialCount = systemItems.length;
                    
                    // Add another system (ensure it's different)
                    const availableIds = [0, 1, 4, 5, 7, 13].filter(id => id !== systemId);
