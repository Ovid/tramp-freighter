...
describe('Property 14: Station Interface Display', () => {
        ...
        fc.assert(
            fc.property(
                ...
                (systemId) => {
                    ...
                    const systemNameElement = document.getElementById('station-system-name');
    ...
    it('should display correct information for Sol system', () => {
        ...
        expect(document.getElementById('station-name').textContent).toBe('Sol Station');
        expect(document.getElementById('station-system-name').textContent).toBe('Sol');
        expect(document.getElementById('station-distance').textContent).toBe('0.0 LY');
    ...
    it('should display correct information for Alpha Centauri system', () => {
        ...
        expect(document.getElementById('station-name').textContent).toBe(`${alphaCentauri.name} Station`);
        expect(document.getElementById('station-system-name').textContent).toBe(alphaCentauri.name);
        
        // Distance should be greater than 0
        const distanceText = document.getElementById('station-distance').textContent;
