...
import { NAVIGATION_CONFIG } from '../../js/game-constants.js';
...
describe('NavigationSystem - Distance Calculations (Property Tests)', () => {
  ...
  it('Property 4: For any star system with coordinates (x, y, z), distance from Sol should equal hypot(x, y, z) * NAVIGATION_CONFIG.LY_PER_UNIT', () => {
    ...
    fc.assert(
      fc.property(starGenerator, (star) => {
        ...
        const expectedDistance =
          Math.hypot(star.x, star.y, star.z) * NAVIGATION_CONFIG.LY_PER_UNIT;
  ...
  it('Property 5: For any two star systems, distance between them should equal hypot(x₁-x₂, y₁-y₂, z₁-z₂) * NAVIGATION_CONFIG.LY_PER_UNIT', () => {
    const navSystem = new NavigationSystem(TEST_STAR_DATA, TEST_WORMHOLE_DATA);
