        ...
        fc.assert(
            fc.property(
                ...
                (cargo) => {
                    ...
                    const expectedCapacity = cargo.reduce((total, stack) => total + stack.qty, 0);
            ...
            fc.property(
                ...
                (quantities) => {
                    ...
                    const cargoMixed = quantities.map((qty, index) => ({
                        good: ['grain', 'ore', 'tritium', 'parts', 'medicine', 'electronics'][index % 6],
                        qty: qty,
                        purchasePrice: 10
                    }));
        ...
        fc.assert(
            fc.property(
                ...
                (initialCargo, newStack) => {
                    const initialCapacity = TradingSystem.calculateCargoUsed(initialCargo);
                    const updatedCargo = [...initialCargo, newStack];
                    const updatedCapacity = TradingSystem.calculateCargoUsed(updatedCargo);
