        ...
        fc.assert(
            fc.property(
                ...
                (capacity, credits, debt, days) => {
                    ...
                    expect(document.getElementById('hud-credits').textContent).toBe(credits.toLocaleString());
                    expect(document.getElementById('hud-debt').textContent).toBe(debt.toLocaleString());
                    expect(document.getElementById('hud-days').textContent).toBe(String(days));
                    expect(document.getElementById('fuel-bar').style.width).toBe('100%');
                    expect(document.getElementById('hud-fuel-text').textContent).toBe('100%');
                    expect(document.getElementById('hud-cargo').textContent).toBe(`${capacity}/${capacity}`);
                }
            ),
            { numRuns: 100 }
        );
        ...
        fc.assert(
            fc.property(
                ...
                (systemId) => {
                    ...
                    expect(document.getElementById('hud-system').textContent).toBe(system.name);
        ...
        fc.assert(
            fc.property(
                ...
                (credits, debt) => {
                    ...
                    const creditsText = document.getElementById('hud-credits').textContent;
