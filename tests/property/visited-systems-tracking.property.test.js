        ...
        fc.assert(
            fc.property(
                ...
                (connection) => {
                    ...
                    const visitedSystems = gameStateManager.getState().world.visitedSystems;
        ...
        fc.assert(
            fc.property(
                ...
                (connection) => {
                    ...
                    const visitedAfterFirstJump = [...gameStateManager.getState().world.visitedSystems];
                    ...
                    const visitedAfterSecondJump = gameStateManager.getState().world.visitedSystems;
                    
                    // Count occurrences of systemId1 in visited list
                    const countSystemId1 = visitedAfterSecondJump.filter(id => id === systemId1).length;
                    
                    // Should only appear once
                    expect(countSystemId1).toBe(1);
                    
                    // Visited list should not have grown (both systems already visited)
                    expect(visitedAfterSecondJump.length).toBe(visitedAfterFirstJump.length);
        ...
        fc.assert(
            fc.property(
                ...
                (systemId1, systemId2) => {
                    ...
                    const initialVisited = [...gameStateManager.getState().world.visitedSystems];
                    ...
                    if (!result.success) {
                        ...
                        const finalVisited = gameStateManager.getState().world.visitedSystems;
