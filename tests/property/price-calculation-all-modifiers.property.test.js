...
describe.skip('Property: Price Calculation with All Modifiers', () => {
  // Commodity types
  const commodities = [
    'grain',
    'ore',
    ...
    fc.assert(
      fc.property(
        ...
        (
          ...
          const stationMod =
            TradingSystem.getStationCountModifier(stationCount);
          ...
          const expectedPrice = Math.round(
            basePrice * productionMod * stationMod * dailyMod * eventMod
          );
    ...
    fc.assert(
      fc.property(
        ...
        (
          ...
          const actualEventMod = TradingSystem.getEventModifier(
            systemId,
            goodType,
            activeEvents
          );
          ...
          const expectedPriceWithEvent = Math.round(
            basePrice * productionMod * stationMod * dailyMod * eventMultiplier
          );
