...
/**
 * Property-based tests for all new NPC data validation
 * Feature: npc-benefits
 * Property: NPC Data Validation
 * 
 ...
 * Tests universal properties that must hold for every NPC definition.
 */
describe('Property-Based Tests: All New NPC Data Validation', () => {
  // Array of all new NPCs for property testing
  const NEW_NPCS = [
    WHISPER,
    CAPTAIN_VASQUEZ,
    DR_SARAH_KIM,
    ...
    fc.assert(
      fc.property(
        ...
        (npc) => {
          ...
          expect(npc.discountService === null || typeof npc.discountService === 'string').toBe(true);
  ...
  it('should have unique IDs across all new NPCs', () => {
    // This is not a property test per se, but validates uniqueness constraint
