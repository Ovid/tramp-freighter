  ...
  it('should require Trusted tier (rep >= 60) for loan requests', () => {
    fc.assert(
      fc.property(arbNPCId(), arbReputation(), (npcId, reputation) => {
        ...
        // Test loan request
        const result = testGameCoordinator.canRequestFavor(npcId, 'loan');
  ...
  it('should require Friendly tier (rep >= 30) for storage requests', () => {
    fc.assert(
      fc.property(arbNPCId(), arbReputation(), (npcId, reputation) => {
        ...
        const result = testGameCoordinator.canRequestFavor(npcId, 'storage');
  ...
  it('should return unavailable with reason when tier is too low', () => {
    fc.assert(
      fc.property(arbNPCId(), arbFavorType(), (npcId, favorType) => {
        ...
        const result = testGameCoordinator.canRequestFavor(npcId, favorType);
    ...
    fc.assert(
      fc.property(
        ...
        (npcId, reputation, invalidFavorType) => {
          ...
          expect(() => {
            const result = testGameCoordinator.canRequestFavor(
              npcId,
              invalidFavorType
            );
    ...
    fc.assert(
      fc.property(
        ...
        (unknownNpcId, favorType) => {
          ...
          expect(() => {
            testGameCoordinator.canRequestFavor(unknownNpcId, favorType);
