    ...
    it('should return the same value for the same inputs (deterministic)', () => {
        fc.assert(
            fc.property(
                ...
                fc.integer({ min: 0, max: 10000 }),
                (systemId, goodType, currentDay) => {
                    const fluctuation1 = TradingSystem.getDailyFluctuation(systemId, goodType, currentDay);
                    const fluctuation2 = TradingSystem.getDailyFluctuation(systemId, goodType, currentDay);
    ...
    it('should return different values for different days', () => {
        fc.assert(
            fc.property(
                ...
                (systemId, goodType, currentDay) => {
                    const fluctuation1 = TradingSystem.getDailyFluctuation(systemId, goodType, currentDay);
                    const fluctuation2 = TradingSystem.getDailyFluctuation(systemId, goodType, currentDay + 1);
    ...
    it('should return different values for different systems on the same day', () => {
        fc.assert(
            fc.property(
                ...
                (systemId, goodType, currentDay) => {
                    const fluctuation1 = TradingSystem.getDailyFluctuation(systemId, goodType, currentDay);
                    const fluctuation2 = TradingSystem.getDailyFluctuation(systemId + 1, goodType, currentDay);
    ...
    it('should return different values for different goods in the same system on the same day', () => {
        fc.assert(
            fc.property(
                ...
                fc.integer({ min: 0, max: 10000 }),
                (systemId, currentDay) => {
                    const fluctuation1 = TradingSystem.getDailyFluctuation(systemId, 'grain', currentDay);
                    const fluctuation2 = TradingSystem.getDailyFluctuation(systemId, 'ore', currentDay);
