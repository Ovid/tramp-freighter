      ...
      fc.property(
        ...
        (numCreations) => {
          ...
          sprites.forEach((sprite) => {
            expect(sprite.material.color).toBe(
              ANIMATION_CONFIG.SHIP_INDICATOR_COLOR
            );
          });
          ...
          sprites.forEach((sprite) => {
            expect(sprite.material.blending).toBe(
    ...
    fc.assert(
      fc.property(fc.constant(true), () => {
        ...
        expect(canvas.height).toBe(
          ANIMATION_CONFIG.SHIP_INDICATOR_TEXTURE_SIZE
        );
