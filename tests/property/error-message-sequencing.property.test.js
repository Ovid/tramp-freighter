    ...
    fc.assert(
      fc.property(
        ...
        (messages) => {
          ...
          let visibleNotifications = notificationArea.querySelectorAll(
          ...
          for (let i = 0; i < messages.length; i++) {
            ...
            visibleNotifications = notificationArea.querySelectorAll(
              '.notification:not(.fade-out)'
            );
    ...
    fc.assert(
      fc.property(
        ...
        (message, duration) => {
          ...
          notifications = notificationArea.querySelectorAll(
            '.notification:not(.fade-out)'
          );
          expect(notifications.length).toBe(1);
      ...
      fc.property(
        ...
        (messages) => {
          ...
          for (let i = 0; i < messages.length; i++) {
            ...
            const visibleNotifications = notificationArea.querySelectorAll(
              '.notification:not(.fade-out)'
            );
