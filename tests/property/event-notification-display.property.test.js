        ...
        fc.assert(
            fc.property(
                ...
                (eventTypeKey, systemId, currentDay, remainingDays) => {
                    ...
                    expect(eventModalDuration.textContent).toContain(String(expectedRemainingDays));
                    ...
                    if (expectedRemainingDays === 1) {
                        ...
                        expect(eventModalDuration.textContent).toContain(`${expectedRemainingDays} days remaining`);
                    }
                }
            ),
            { numRuns: 100 }
