...
import { calculateDistanceFromSol, LY_PER_UNIT } from '../../js/game-constants.js';
...
const TEST_STAR_DATA = [
    ...
    { "id": 1, "x": -23.1, "y": -19.18, "z": -53.76, "name": "Alpha Centauri A", "type": "G2" },
    { "id": 3, "x": -21.56, "y": -16.38, "z": -52.5, "name": "Proxima Centauri C", "type": "M5.5" },
    ...
    { "id": 13, "x": 87.22, "y": 115.92, "z": -24.22, "name": "Epsilon Eridani", "type": "K2" },
...
describe('Distance Calculations', () => {
    ...
    describe('calculateDistanceFromSol', () => {
        ...
        it('should calculate Alpha Centauri A at ~4.37 LY', () => {
            const alphaCen = TEST_STAR_DATA.find(s => s.name === 'Alpha Centauri A');
        ...
        it('should calculate Proxima Centauri C at ~4.25 LY', () => {
            const proxima = TEST_STAR_DATA.find(s => s.name === 'Proxima Centauri C');
