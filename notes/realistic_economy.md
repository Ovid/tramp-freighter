...
* This creates permanent, predictable gradients. A player knows *intuitively* that flying away from Sol increases the value of Electronics.
...
Add a new ECONOMY\_CONFIG object. Tunable constants are critical here to balance "Game Days" vs. "Real Time" feel.
...
2. Multiply every value by ECONOMY\_CONFIG.DAILY\_RECOVERY\_FACTOR.  
...
*User Requirement: This specific route must be safe and profitable.*
...
1. \[ \] **game-constants.js**: Add ECONOMY\_CONFIG with calibrated Tech Biases.  
2. \[ \] **game-state.js**:  
