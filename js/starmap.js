...
class GameStateManager {
    // Commodity base prices in credits
    static BASE_PRICES = {
        grain: 10,
        ore: 15,
        tritium: 50,
    ...
    calculateGoodPrice(goodType, spectralClass) {
        const basePrice = GameStateManager.BASE_PRICES[goodType] || 10;
        const spectralLetter = spectralClass.charAt(0).toUpperCase();
        const modifier = GameStateManager.SPECTRAL_MODIFIERS[spectralLetter]?.[goodType] || 1.0;
