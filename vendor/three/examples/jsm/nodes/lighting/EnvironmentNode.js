    ...
    const radianceContext = context(envNode, {
      getUVNode: (textureNode) => {
        ...
        if (reflectVec === undefined) {
          reflectVec = positionViewDirection
            .negate()
            .reflect(transformedNormalView);
          reflectVec = reflectVec
            .mix(transformedNormalView, roughness.mul(roughness))
            .normalize();
        ...
        if (textureNode.isCubeTextureNode) {
          ...
          if (radianceTextureUVNode === undefined) {
            ...
            radianceTextureUVNode = vec2(
              radianceTextureUVNode.x,
      ...
      getUVNode: (textureNode) => {
        ...
        if (textureNode.isCubeTextureNode) {
          ...
          if (irradianceTextureUVNode === undefined) {
            ...
            irradianceTextureUVNode = vec2(
              irradianceTextureUVNode.x,
              irradianceTextureUVNode.y.invert()
            );
          }
