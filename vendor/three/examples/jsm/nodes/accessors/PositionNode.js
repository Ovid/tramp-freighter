  ...
  generate(builder) {
    ...
    if (scope === PositionNode.GEOMETRY) {
      ...
      const vertexPositionNode =
        modelWorldMatrix.transformDirection(positionLocal);
...
export const positionGeometry = nodeImmutable(
  PositionNode,
  PositionNode.GEOMETRY
);
...
export const positionWorldDirection = nodeImmutable(
  PositionNode,
  PositionNode.WORLD_DIRECTION
);
export const positionView = nodeImmutable(PositionNode, PositionNode.VIEW);
export const positionViewDirection = nodeImmutable(
  PositionNode,
  PositionNode.VIEW_DIRECTION
);
