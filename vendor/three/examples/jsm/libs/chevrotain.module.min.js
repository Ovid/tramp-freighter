...
var ne = R((S) => {
  ...
  function ht(t) {
    ...
    if (t instanceof Dt) {
      ...
      return (
        t.terminalType.PATTERN && (r.pattern = G.isRegExp(n) ? n.source : n),
        r
      );
    } else {
      if (t instanceof Yn)
...
var Tt = R((j) => {
  ...
  function Zo(t, e, r, n) {
    ...
    return (
      a.push(1),
      { idx: e, def: t.definition, ruleStack: i, occurrenceStack: a }
    );
  }
});
var yt = R((C) => {
